    ...
    authContainer.innerHTML = `
      <div id="authModal" class="auth-modal">
        <div class="auth-content">
          <h3 style="margin-top:0; color:#0f3c7d; font-size:22px; text-align:center;">Đăng nhập</h3>
          <p style="text-align:center; font-size:13px; color:#6b7280; margin-bottom:20px;">(Admin: admin/123 | User: khachhang/123)</p>
          ...
          <button class="auth-btn auth-close" onclick="document.getElementById('authModal').classList.remove('active')">Hủy</button>
        </div>
      </div>
    `;
